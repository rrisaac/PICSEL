...
// Custom event code to handle actions inside a DataTable
// @author Gacel Perfinian
// @date 04/27/2024
window.DataTableAction = new Event("DataTableAction");

window.DataTableActionPress = (el) => {
	'use strict'

	// Update DataTableActionData object
	let data = {}
	data.id = el.dataset.id
	data.action = el.dataset.action
	window.DataTableActionData = data

	// Trigger event
	dispatchEvent(window.DataTableAction)
}