// Description: A classification page made for users that signed up using Google 
// with Password, Re-enter Password, and Contact number fields
...
// Description: Add explicit validators on fields: Password, Retype Password, Contact Number, and Student Number.
...
const GoogleSignUpClassificationPage = () => {
  const navigate = useNavigate();
  const location = useLocation(); 
  const googleIdFromSignup = location.state?.userId || ''; // Retrieve the email passed from the signup page
  ...
  const handleClassify = async (e) => {
    ...
    const result = await api.googleClassify(options);
  ...
  const handlePasswordBlur = () => {
    const error = validatePassword(gPassword);
    setValidationErrors(prev => ({ ...prev, password: error, reenterPassword: '' }));
  };

  const handleReEnterPasswordBlur = () => {
    const error = validatePasswordMatch(gPassword, reEnterPassword);
    ...
    <div className="app app-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
      ...
      <div className="app-auth-container">
        ...
        <div className="auth-credentials page-m-b-xxl">
          ...
          {/* Password, Re-enter Password, and Contact Number Input if Google signup is used */}
          <div className="fields-wrapper">
            <div className="field">
              {/* Password Input */}
              <label htmlFor="gPassword" className="gpassword-form-label">
                Password
                <i 
            ...
            <div className="field">
              ...
              <label htmlFor="reEnterPassword" className="reenterpassword-form-label">
                Re-enter Password
              </label>
              <input
                type="password"
          ...
          <label htmlFor="contactNumber" className="contactnumber-form-label">
            Contact number
          </label>
          <input
            type="tel"
...
export default GoogleSignUpClassificationPage;